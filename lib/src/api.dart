...
class API extends Api {
  ...
  Future<Map<String, dynamic>?> _get(String endpoint,
    ...
    print('GET $endpoint');
    Response response;
    String? url = isRopsten ? toRopsten(_base!) : _base;
    Uri uri = Uri.parse('$url/$endpoint');
    if (private != null && private) {
      response = await _client
          .get(uri, headers: {"Authorization": "Bearer $_jwtToken"});
    } else {
  ...
  Future<bool> loginRequest(String phoneNumber) async {
    Map<String, dynamic> resp =
        await (_post('v2/login/request', body: {"phoneNumber": phoneNumber}) as FutureOr<Map<String, dynamic>>);
    if (resp["response"] == "ok") {
      return true;
    } else {
  ...
  Future<dynamic> createWalletOnForeign({bool force = false}) async {
    ...
    Map<String, dynamic> resp = await (_post(endpoint, private: true) as FutureOr<Map<String, dynamic>>);
    if (resp["job"] != null) {
      return resp;
    } else {
  ...
  Future<dynamic> createWallet({String? communityAddress}) async {
    ...
    final dynamic body = communityAddress != null
        ...
        : null;
    Map<String, dynamic> resp =
        await (_post('v2/wallets', private: true, body: body) as FutureOr<Map<String, dynamic>>);
    if (resp["job"] != null) {
      return resp;
    } else {
  ...
  Future<List<dynamic>> fetchTokenTxByAddress(
    ...
    Map<String, dynamic> resp = await (_get(
        ...
        private: true) as FutureOr<Map<String, dynamic>>);
    List<dynamic> transfers = [];
  ...
  Future<dynamic> getCommunityData(String communityAddress,
    ...
    Map<String, dynamic> resp =
        await (_get(url, private: false, isRopsten: isRopsten) as FutureOr<Map<String, dynamic>>);
    return resp['data'];
  }
  ...
  Future<dynamic> getEntityMetadata(String communityAddress, String account,
    ...
    Map<String, dynamic> resp = await (_get(
        ...
        isRopsten: isRopsten) as FutureOr<Map<String, dynamic>>);
    return resp['data'];
  }

  Future<dynamic> syncContacts(List<String> phoneNumbers) async {
    Map<String, dynamic> resp = await (_post('v2/contacts',
        body: {"contacts": phoneNumbers}, private: true) as FutureOr<Map<String, dynamic>>);
    return resp["data"];
  }
  ...
  Future<dynamic> fetchMetadata(String uri, {bool isRopsten = false}) async {
    Map<String, dynamic> resp =
        await (_get('v1/metadata/$uri', private: false, isRopsten: isRopsten) as FutureOr<Map<String, dynamic>>);
    return resp['data'];
  }

  Future<dynamic> getFunderJob(String id) async {
    Client funderClient = new Client();
    Uri uri = Uri.parse('$_funderBase/job/$id');
    Response response = await funderClient.get(uri);
  ...
  Future<dynamic> totleSwap(
    ...
    Map<String, dynamic> signedSwapData = await web3.callContractOffChain(
        ...
        network: network);
    Map<String, dynamic>? resp =
        await (multiRelay([signedApprovalData, signedSwapData]) as FutureOr<Map<String, dynamic>?>);
    return resp;
  }
  ...
  Future<dynamic> transferTokenToHomeWithAMBBridge(
    ...
    List<dynamic> signData = await web3.transferTokenToHome(walletAddress,
        ...
        network: network);
    Map<String, dynamic>? resp = await (multiRelay(signData) as FutureOr<Map<String, dynamic>?>);
    return resp;
  }
